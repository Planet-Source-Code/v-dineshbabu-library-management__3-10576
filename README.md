...
---                |---
**Submitted On**   |
**By**             |[V\.Dineshbabu](https://github.com/Planet-Source-Code/PSCIndex/blob/master/ByAuthor/v-dineshbabu.md)
**Level**          |Advanced
...
**Archive File**   |[](https://github.com/Planet-Source-Code/v-dineshbabu-library-management__3-10576/archive/master.zip)
...
void library::flash()
{
 ...
 textattr(697);
 textcolor(692);
 gotoxy(3,3);cprintf(" [LIBRARY INFORMATION SYSTEM]           ");
 textattr(697);textattr(693);
 gotoxy(3,22);cprintf(" Designed By :- II YEAR IT");
 gotoxy(3,23);cprintf(" M.K.E.C");
 textattr(7);
}
void library::about()
{
...
gotoxy(10,10);textcolor(3);cprintf("........................... ");
 gotoxy(10,11);textcolor(6);cprintf(" STUDENTS          ");
 gotoxy(10,12);cprintf(" B.E (IT)");
 gotoxy(10,13);cprintf("M.K.E.C");
 gotoxy(10,14);puts("         *******************");
 textcolor(2);
...
gotoxy(2,9);cout<<"-------------------------------";
   ...
   i.sno=tem;
   gotoxy(2,7);cout<<"BOOK NO. BOOK's NAME AUTHOR PUBLICATION  PRICE ";
gotoxy(2,8);cout<<"------------------------------------------------";
 ...
 while(another=='y')
 {
  ...
  if (r.sno==b.sno)
   ...
   while(fread(&i,sizeof(i),1,fe)==1)
   {
    if(r.sno==i.sno)
    {
	gotoxy(2,7);cout<<"BOOK_NO BOOKS_NAME     ISSUED TO     ROLL   C_CODE  ISSUE_DATE ";
gotoxy(2,8);cout<<"------------------------------------";
...
void library::querybystd()
{
 ...
 while(fread(&i,sizeof(i),1,ft)==1)
   ...
   if((strcmpi(q.code,i.code)==0)&&(q.roll==i.roll))
   {
    ...
    gotoxy(2,7);cout<<"BOOK_NO. BOOKS_NAME       AUTHOR PUBLICATION  ISSUE_DATE ";
gotoxy(2,8);cout<<"----------------------------------------------------------------------";
    gotoxy(2,9+c);cout<<" ";
    rewind(fp);
...
void library::issuelist()
{
 ...
 textattr(697);
 textcolor(692);
 gotoxy(3,4);cprintf(" [  ISSUED BOOKS TAILS  ]           ");
 textattr(7);
...
gotoxy(2,8);cout<<"--------------------------------------------------------------------------";
 ...
 if(c>10)
  ...
  textattr(697);
  textcolor(692);
  gotoxy(3,4);cprintf("        [ ISSUED BOOKS ILS   ]           ");
  textattr(7);
  gotoxy(2,7);cout<<"Sl.No. ISSUED TO    ROLL C_Code BOOK_NO BOOKS_NAME    ISSUE_DATE ";
gotoxy(2,8);cout<<"-----------------------------";
  }
 }
 gotoxy(60,20);cout<<"End of List ";
...
void library::returnlist()
{
 ...
 textattr(7);
 gotoxy(2,7);cout<<"Sl.No. RETURNED BY   ROLL C_Code BOOK_NO BOOKS_NAME    RETURN_DATE";
gotoxy(2,8);
cout<<"---------------------------";
 while (fread (&r,recsize,1,fp) == 1)
 {
...
gotoxy(2,10);cout<<"----------------------------------------------------------------------------";
	...
	gotoxy(3,4);cprintf("             [   MODIFY   DS   ]           ");
	textattr(7);
	gotoxy(10,12);cout<<"------------------------NO RECORD FOUND----------------------- ";
    }
   }
...
void library::delreturn()
{
 ...
 while(another=='y')
  ...
  gotoxy(3,4);cprintf("             [   DELETE DS   ]           ");
  textattr(7);
  gotoxy(10,12);cout<<"------------------------RECORD  DELETED----------------------- ";
